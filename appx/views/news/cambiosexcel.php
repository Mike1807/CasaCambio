<?php
	...
	if($resultado->num_rows > 0 ){
		...
		$titulosColumnas = array('FECHA', 'ID', 'NOMBRE', 'MONEDA DE ORIGEN', 'MONEDA DE CAMBIO','CANTIDAD', 'TOTAL');
		...
		while ($fila = $resultado->fetch_array()) {
			$objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('D'.$i,  $fila['moneda_origen'])
                    ->setCellValue('E'.$i,  $fila['moneda_cambio'])
		...
		header('Content-Disposition: attachment;filename="Reporte_cambios.xlsx"');
